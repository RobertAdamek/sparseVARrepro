# Simulation Script
rm(list=ls())
#install.packages("/home/radamek/bootstrap_stuff/sparseVARboot_0.2.0.tar.gz", repos=NULL, type="source")
...
save(reject, file = "/home/output/dgp2_power_mu00175_prop05.RData")